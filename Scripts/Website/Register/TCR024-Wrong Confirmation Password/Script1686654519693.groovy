...
WebUI.verifyElementText(findTestObject('Object Repository/Register/Page_Buat akun dan dapatkan akses di Coding.ID/validate_password does not match'), 'kata sandi tidak sama')
